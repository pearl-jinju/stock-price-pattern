...
class BusinessDayDate(models.Model):
    date           = models.TextField()  # 티커


class StockPricePattern(models.Model):
    name             = models.TextField()   # 종목명
    analysis_period  = models.IntegerField()  # 티커
    start_day        = models.TextField()   # 시작 일자 
    end_day          = models.TextField()   # 종료 일자 
    price_list       = models.TextField()   # 주가 정보 리스트 
    fluctuation_list = models.TextField()   # 등락률 정보 리스트  
    rate_volume_list = models.TextField(default=None)   # 전일대비거래량 정보 리스트 
    MA224_list       = models.TextField()   # 224일 평균 정보 리스트 
    MA224_ratio_list = models.TextField()   # 주가/224일 평균 정보 리스트
    rate_MA224_mean_list  = models.TextField()   # 224일 등락률 평균 정보 리스트    
    rate_MA224_std_list   = models.TextField()   # 224일 등락률 표준편차 정보 리스트
    yield_5days   = models.TextField()   # 224일 등락률 표준편차 정보 리스트
    yield_20days   = models.TextField()   # 224일 등락률 표준편차 정보 리스트
    yield_60days   = models.TextField()   # 224일 등락률 표준편차 정보 리스트
